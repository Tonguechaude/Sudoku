...
// dmaj : 24 septembre 2023 + modifs tp note s4
...
public class Ut {
   ...
   public static void afficher (boolean b) {
	...
	public static void afficherSL (Object[] tab) {
	...
	public static void afficherSL (char[] tab) {
		afficher(tab); passerLigne();
	}
	...
	public static void afficherSL (double[] tab) {
		afficher(tab); passerLigne();
	}

	public static void afficher (boolean[] tab) {
		System.out.print(Arrays.toString(tab) + "");
	}

	public static void afficherSL (boolean[] tab) {
		afficher(tab); passerLigne();
	}

	public static void afficher (long[] tab) {
		System.out.print(Arrays.toString(tab) + "");
	}

	public static void afficherSL (long[] tab) {
		afficher(tab); passerLigne();
	}

	public static void afficher (short[] tab) {
		System.out.print(Arrays.toString(tab) + "");
	}

	public static void afficherSL (short[] tab) {
		afficher(tab); passerLigne();
	}
	...
	public static void afficherSL (float[] tab) {
		afficher(tab); passerLigne();
	}
